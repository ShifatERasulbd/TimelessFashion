            ...
            <div className="border-b border-zinc-200 bg-[#f4f4f4] backdrop-blur">
                <div className="mx-auto flex h-[90px] max-w-[1920px] items-center justify-between gap-4 px-4 sm:px-6 lg:px-10">
                    ...
                    <div className="flex items-center gap-2 sm:gap-3">
                        <a
                            href="#customize"
                            className="inline-flex items-center gap-2 rounded-sm bg-[#e65c00] px-3.5 py-2 text-[0.78rem] font-semibold uppercase tracking-[0.2em] text-white transition-transform hover:-translate-y-0.5 hover:bg-[#d55400] sm:px-4"
                        >
